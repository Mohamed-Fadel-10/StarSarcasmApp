...
namespace StarSarcasm.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribersNumber = table.Column<int>(type: "int", nullable: false,defaultValue:0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersDraws", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersDraws_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersDraws_Draws_DrawId",
                        column: x => x.DrawId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersMessages_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersDraws_DrawId",
                table: "UsersDraws",
                column: "DrawId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersDraws_UserId",
                table: "UsersDraws",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersMessages_MessageId",
                table: "UsersMessages",
                column: "MessageId");
